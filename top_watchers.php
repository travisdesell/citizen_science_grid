...
if ($min > 0) {
    echo "<a type='button' class='btn btn-default pull-left' href='./top_watchers.php?sort=$sort&min=$prev_min'>
                    <span class='glyphicon glyphicon-chevron-left'></span> Previous 
                </a>";
}

echo "
                <a type='button' class='btn btn-default pull-right' href='./top_watchers.php?sort=$sort&min=$next_min'>
...
$result = query_boinc_db("SELECT id, name, valid_events, bossa_total_credit, country, create_time FROM user ORDER BY $sort_by LIMIT $min, 20");
...
$navbar_template = file_get_contents($cwd[__FILE__] . "/templates/top_watchers.html");
