    ...
    $navbar_info = array('project_name' => 'CSG',
                       ...
                       'brand-dropdowns' => array(
                            ...
                            array('dropdown_title' => 'Projects',
                                  'divider' => true,
                                  'url' => 'javascript:;'),
                            array('dropdown_title' => 'Climate Tweets',
                                  'url' => 'http://csgrid.org/csg/climate'),
                            array('dropdown_title' => 'DNA@Home',
                                  'url' => 'http://csgrid.org/csg/dna'),
                            array('dropdown_title' => 'SubsetSum@Home',
                                  'url' => 'http://csgrid.org/csg/subset_sum'),
                            ...
                            array(
                                ...
                                'dropdowns' => array(
                                    ...
                                    array('dropdown_title' => 'Top DNA@Home Users',
                                          'url' => 'http://csgrid.org/csg/per_app_list.php?appid=13&is_team=&is_total=1'),
                                    array('dropdown_title' => 'Top SubsetSum@Home Users',
                                          'url' => 'http://csgrid.org/csg/per_app_list.php?appid=15&is_team=&is_total=1'),
                                    array('dropdown_title' => 'Top Wildlife@Home Users',
                                          'url' => 'http://csgrid.org/csg/per_app_list.php?appid=12&is_team=&is_total=1'),
                                    array('dropdown_title' => 'Climate Tweets',
                                          'divider' => true,
                                          'url' => 'javascript:;'),
                                    array('dropdown_title' => 'Top Tweeters',
                                          'url' => "$base_dir/top_tweeters.php"),
                                    array('dropdown_title' => 'Top Tweeter Teams',
                                          'url' => "$base_dir/top_tweeter_teams.php"),
                                    array('dropdown_title' => 'Wildlife@Home',
                                          'divider' => true,
                                          'url' => 'javascript:;'),
